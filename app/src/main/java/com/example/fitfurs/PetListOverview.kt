...
import com.example.fitfurs.PetCardOverview


@Composable
fun PetListOverview(navController: NavHostController, username: String) {
                ...
                LazyColumn(
                    ...
                    items(pets) { pet ->
                        ...
                        PetCardOverview(
                            ...
                            onClick = {
                                navController.navigate("pet_profile/$username/$petId")
                            }
                        )
                    }
                }
